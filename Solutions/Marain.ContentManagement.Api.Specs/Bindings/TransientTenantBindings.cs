...
namespace Marain.ContentManagement.Specs.Bindings
{
    ...
    public static class TransientTenantBindings
    {
        ...
        /// <see cref="GetTransientTenant(FeatureContext)"/> or <see cref="GetCurrentTenantId(FeatureContext)"/>.
        /// </remarks>
        [BeforeFeature("useTransientTenant", Order = BindingSequence.SetupTransientTenant)]
        ...
        public static string GetCurrentTenantId(this FeatureContext context)
        {
